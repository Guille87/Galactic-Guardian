...
class CollisionManager:
    ...
    Las consecuencias de **reglas de partida** (puntuación, combo, progresión de
    nivel, muerte/reaparición del jugador) NO se aplican aquí: se delegan en
    `reglas`, que debe ofrecer dos métodos:

      - ``reglas.al_eliminar_enemigo(enemigo)`` — puntuación, combo, transición
    ...
    Colisiones:
      ...
      - Contacto cuerpo a cuerpo: colisión rectangular.
    """
    ...
    def _eliminar_enemigo(self, enemigo):
        ...
        # Puntuación, combo y transición de jefe: reglas de partida.
