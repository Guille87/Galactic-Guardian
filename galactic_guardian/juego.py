...
class Juego:
    def __init__(self):
        ...
        self.pantalla_ancho = 600
        self.pantalla_alto = 800
        self.pantalla = pygame.display.set_mode((self.pantalla_ancho, self.pantalla_alto))  # Crea la ventana del juego

        # Cargar imagen del fondo
        self.fondo_imagen1 = pygame.image.load('imagenes/fondo1.jpg')
        self.fondo_imagen2 = pygame.image.load('imagenes/fondo2.jpg')
        self.pos_y_fondo1 = 0
        ...
        pygame.mixer.music.set_volume(0.1)  # Establecer volumen de la música de fondo
